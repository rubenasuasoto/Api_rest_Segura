    ...
    fun securityFilterChain(http: HttpSecurity):SecurityFilterChain {
        ...
        return http
            ...
            .authorizeHttpRequests{auth ->auth
                ...
                .requestMatchers("/citas/register").hasRole("Mecanico")
                ...
                .requestMatchers(HttpMethod.PUT,"/talleres/{id}").hasRole("Mecanico")
                .requestMatchers(HttpMethod.DELETE,"/talleres/{id}").hasRole("Mecanico")
